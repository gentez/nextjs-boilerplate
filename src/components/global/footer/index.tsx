                ...
                <div className="container">
                    <div className="grid gap-y-10 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-5 lg:py-[100px]">
                        ...
                        <h2 className="text-secondary text-4xl font-extrabold leading-normal sm:text-5xl lg:text-[25px] lg:leading-[45px] ">JAALNET</h2>
                                ...
                                <li>
                                    <Link href="#">
                                        <svg
                                            ...
                                            className="transition text-gray hover:scale-110 hover:text-secondary"
                                        >
                                            <path
                            ...
                            <img src="/images/footer-shape.png" alt="footer-shape" className="absolute bottom-0 right-0 sm:left-0" />
                            <img
                        ...
                        <div>
                            <ul className="flex flex-col gap-3 font-bold">
                                ...
                                <li>
                                    <Link href="/portfolio" className="inline-block text-gray transition hover:scale-110 hover:text-secondary">
                                        Portfolio
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/services" className="inline-block text-gray transition hover:scale-110 hover:text-secondary">
                                        Service
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/team" className="inline-block text-gray transition hover:scale-110 hover:text-secondary">
                                        Team
                                    </Link>
                                </li>
                                <li>
                        ...
                        <div>
                            <ul className="flex flex-col gap-3 font-bold">
                                ...
                                <li>
                                    <Link href="/services-detail" className="inline-block text-gray transition hover:scale-110 hover:text-secondary">
                                        UI/UX Design
                                    </Link>
                                </li>
                                <li>
                        ...
                        <div>
                            <ul className="flex flex-col gap-3 font-bold">
                                ...
                                <li>
                                    <Link href="/terms-conditions" className="inline-block text-gray transition hover:scale-110 hover:text-secondary">
                                        Terms & Conditions
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/privacy-policy" className="inline-block text-gray transition hover:scale-110 hover:text-secondary">
                                        Privacy Policy
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/faq" className="inline-block transition text-gray hover:scale-110 hover:text-secondary">
                                        FAQs
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/blog" className="inline-block transition text-gray hover:scale-110 hover:text-secondary">
                                        Blog
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div>
                            <ul className="flex flex-col gap-3 font-bold">
                                <li className="mb-3 text-lg font-extrabold text-gray dark:text-white">Information</li>
                                <li className='text-gray'>164 Brighton Ave, Allston, Maine, U.S. - 02134</li>
                                <li>
                                    <a href="tel:+(617) 254-2333" className="inline-block text-gray transition hover:scale-110 hover:text-secondary">
                                        +(617) 254-2333
                                    </a>
                                </li>
                            </ul>
