...
const index = () => {
  return (
    <section className="bg-[url(/images/service-bg.png)] bg-cover bg-center bg-no-repeat py-14 dark:bg-none lg:py-[100px]">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div data-aos="fade-up" data-aos-duration="1000">
            ...
            >
              ...
              <p className=" mb-10  line-clamp-3 text-lg font-semibold text-black transition dark:group-hover:text-black">
