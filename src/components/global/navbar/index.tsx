...
// import logo from '../../../../public/images/wrap.jpg';
...
//   <Image src={logo} width={50} height={50} alt='logo' className='rounded-lg mx-2'/>
//   <Link
        ...
        <header className={`sticky top-0 z-50 bg-black duration-300 ${props.className}`}>
            <div className="container">
                <div className="flex items-center justify-between py-5 lg:py-0">
                    <Link href="/">
                        <img src="../../../images/wrap.js" alt="Jaalnet" className="h-10 w-full" />
