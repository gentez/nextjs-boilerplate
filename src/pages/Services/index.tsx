        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div data-aos="fade-up" data-aos-duration="1000">
            ...
            >
              ...
              <p class=" mb-10  line-clamp-3 text-lg font-semibold text-gary transition dark:group-hover:text-black">
          ...
          <div data-aos="fade-up" data-aos-duration="1000">
            ...
            >
              ...
              <p class="mb-10  line-clamp-3 text-lg font-semibold text-gray transition dark:group-hover:text-black">
